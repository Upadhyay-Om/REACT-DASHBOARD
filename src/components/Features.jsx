        ...
        <div class="flex flex-col space-y-8 md:w-1/2">
          ...
          >
            ...
            <div>
              ...
              <p class="text-darkGrayishBlue"style={{ whiteSpace: 'pre-line' }}>
                See how your day-to-day tasks fit into the wider vision.<br/>Go from
              tracking progress at the milestone level all the <br/>way down to the
                smallest of details.<br/> Never lose sight of the bigger picture
                again.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <p class="text-darkGrayishBlue">
                ...
                files, track tasks and share documents.<br/> Manage offers an
